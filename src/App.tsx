...
import ExamPlannerPage from "./pages/dashboard/ExamPlannerPage";
import ParentDashboardPage from "./pages/dashboard/ParentDashboardPage";
import CounselorDashboardPage from "./pages/dashboard/CounselorDashboardPage";
import AbsenceJustificationPage from "./pages/dashboard/AbsenceJustificationPage";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/dashboard" element={<DashboardLayout />}>
            ...
            <Route path="attendance" element={<AbsenceJustificationPage />} />
            {/* Teacher routes */}
            ...
            {/* Counselor */}
            <Route path="counselor-home" element={<CounselorDashboardPage />} />
            {/* Shared */}
